...
export default function Userstransactions() {
    ...
    <Layout>
      <div className="w-2/4 mx-auto p-6 bg-gray-100 rounded-lg shadow-md">
        ...
        <h2 className="text-lg font-semibold border-b mb-2 text-center">Movimientos</h2>
        <div className="flex justify-end mb-4">
          <Button className="px-4 py-2 bg-gray-600 rounded hover:bg-gray-700 hover:scale-110">
            Nueva transacción
          </Button>
      </div>
